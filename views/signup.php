...
<form action="<?php echo base_url();?>index.php/hello/signuprequest" style="border:1px solid #ccc" method="post">
  <div class="container">
...
<p> Please select your gender <p>
  ...
  <br>
    ...
    <div class="clearfix">
			...
			<div align="left"><a href="<?php echo base_url();?>index.php/hello/mysixthpage" class="next"><button type="submit" class="signupbtn">Sign Up</button> <b></a><br/></b></a></div></div>
