...
function validateForm(){
	if( document.forms["add_genre"]["Genre"].value == ""){
...
<body>
	...
	<body style="background-color:#65DEAD ;">
		...
		<h1 style="text-align: center; color: #ffffff;">Add Genre</h1>
		<style>
		a {
	 ...
	 if(isset($result))
  {
    ...
    echo '<form name="addgenre" action"'. base_url(). 'idex.php/Hello/add_genre" onsubmit="return validateForm()" method="post">
		Genre Name: <br> <input type="text" name="Genre"><br><br>';
