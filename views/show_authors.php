...
<p></p>
<h1 style="text-align: center; color: #ffffff;">Our Authors</span>🌷</h1>
...
<div class="divTableBody">
      ...
      <?php
			...
			foreach ($authors as $author) {
				...
				echo '<div class="divTableCell">'.$author->Author_ID.'</div>';
				echo '<div class="divTableCell">'.$author->Author_Name.'</div>';
